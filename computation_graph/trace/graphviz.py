...
def computation_graph_to_graphviz(edges: frozenset[base_types.ComputationEdge]) -> pgv.AGraph:
...
def computation_trace_to_graphviz(
    computation_trace: Iterable[Tuple[base_types.ComputationNode, base_types.Result]]
) -> pgv.AGraph:
    ...
    for node, result in computation_trace:
        ...
        graphviz_node.attr["result"] = str(result)[:200]
